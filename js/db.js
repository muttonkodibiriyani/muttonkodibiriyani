...
const AIC_DB = (function () {
  ...
  function getSampleUsers() {
    return [
      ...
      { id:'usr-002', email:'sarah.rashidi@alshaya.com', name:'Sarah Al-Rashidi',    role:'Strategy_Reviewer',    department:'Corporate Strategy',  title:'Strategy Director',           initials:'SR', active:true },
      { id:'usr-003', email:'faisal.tamimi@alshaya.com', name:'Faisal Al-Tamimi',    role:'Investment_Committee', department:'Technology Strategy', title:'Chief Technology Officer',    initials:'FT', active:true },
